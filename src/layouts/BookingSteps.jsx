  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 bg-green-500 rounded-full w-14 h-14 flex items-center justify-center shadow-lg cursor-pointer hover:bg-green-600 transition duration-300"
      >
        <svg
      ...
      <a
        ...
        className="fixed bottom-6 right-6 bg-green-500 rounded-full w-14 h-14 flex items-center justify-center shadow-lg cursor-pointer hover:bg-green-600 animate-blink transition duration-300"
        title="Call Us"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
