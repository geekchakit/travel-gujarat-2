...
const BookingSteps = () => {
  const steps = [
    {
      ...
      description:
        "Begin by deciding what kind of travel experience you're looking for. We've got you covered.",
    },
    {
      id: 2,
      ...
      title: "Send Enquiry",
      description:
        "Please fill out the enquiry form with necessary details and send us an enquiry.",
    },
    {
      id: 3,
      ...
      description:
        "Our customer care executive will get in touch with you at the earliest and help you with your booking.",
    },
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      {/* WhatsApp Icon */}
      <div className="fixed bottom-6 right-6 bg-green-500 rounded-full w-14 h-14 flex items-center justify-center shadow-lg cursor-pointer hover:bg-green-600 transition duration-300">
        <svg
